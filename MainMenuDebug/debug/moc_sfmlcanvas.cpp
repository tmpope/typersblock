...
QT_MOC_LITERAL(3, 25, 13), // "keyPressEvent"
QT_MOC_LITERAL(4, 39, 10), // "QKeyEvent*"
QT_MOC_LITERAL(5, 50, 14) // "updateGameTime"

    },
    "SFMLCanvas\0widgetClosed\0\0keyPressEvent\0"
    "QKeyEvent*\0updateGameTime"
};
...
void SFMLCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->updateGameTime(); break;
        default: ;
        }
        ...
        {
            typedef void (SFMLCanvas::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SFMLCanvas::widgetClosed)) {
                *result = 0;
            }
        }
    }
